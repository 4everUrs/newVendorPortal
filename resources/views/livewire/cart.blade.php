<div>
        ...
        <tbody>
          @foreach ($items as $key => $item)
            <tr>
              <td data-th="Product">
                <div class="row">
                  <div class="col-sm-2 hidden-xs"><img src="https://mnlph.nyc3.digitaloceanspaces.com/{{$item->VendorShop->thumbnail}}" alt="..." class="img-responsive" /></div>
                  <div class="col-sm-10">
              ...
              <td class="actions" data-th="">
                <button wire:click="addQty({{$item->id}},{{$key}})" class="btn btn-info btn-sm"><i class="fa fa-refresh"></i></button>
                <button wire:click="removeItem({{$item->id}})" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button>
              </td>
            </tr>
          @endforeach
    </tbody>
    <tfoot>
      ...
      <tr>
        ...
        <td colspan="2"><button wire:click="checkoutShowModal" class="btn btn-success btn-block">Checkout <i class="fa fa-angle-right"></i></button></td>
      </tr>
    </tfoot>
  </table>
</div>
