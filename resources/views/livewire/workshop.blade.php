            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex align-items-start flex-nowrap justify-content-start">
                        <img src="{{asset('dashboardPage/assets/img/logz.png')}}" class="rounded-circle d-block"
                        ...
                        <div class="ps-4">
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-start gap-3">
                                ...
                                <div><i class="fa-solid fa-dollar-sign"></i> @money($post->start) - @money($post->end)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row p-4 border border-secondary rounded">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-6 text-end">{{$post->content}}</div>
                            </div>
                            <div class="row mb-4">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    @auth
                                    <button wire:click="workshopApply"
                                        class="d-inline-block px-4 py-2 rounded bg-secondary text-white align-middle">Apply
                                        Now</button>
                                    @endauth
